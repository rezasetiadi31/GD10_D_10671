...
import com.example.gd10_d_10671.*
import com.example.gd10_d_10671.databinding.FragmentDataMahasiswaBinding
...
class DataMahasiswaFragment : Fragment() {
    ...
    private fun getDataMahasiswa(){
        ...
        RClient.instance.getData(cari).enqueue(object : Callback<ResponseDataMahasiswa>{
