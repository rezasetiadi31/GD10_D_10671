...
import com.example.gd10_d_10671.databinding.ActivityDetailMahasiswaBinding
import okhttp3.Call
...
class DetailMahasiswaActivity : AppCompatActivity() {
    ...
    fun getDataDetail(nim: String) {
        RClient.instance.getData(nim).enqueue(object : retrofit2.Callback<ResponseDataMahasiswa> {
